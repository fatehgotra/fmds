...
class SarController extends Controller
{
    ...
    public function Registration(Request $request)
    {
        ...
        return view('user.application.student-annual-registration.education');
    }
    ...
    public function Education(Request $request)
    {
        ...
        if (!isset($request->back) && isset($inputs))
            session()->put('education', $inputs);
        return view('user.application.student-annual-registration.other-acheivement');
    }

    public function otherAcheivement(Request $request)
    {

        $inputs = $request->except('_token');

        if (!isset($request->back) && isset($inputs))
            session()->put('other_acheivement', $inputs);
        return view('user.application.student-annual-registration.medical-fitness');
    }
    ...
    public function medicalFitness(Request $request)
    {
        ...
        return view('user.application.student-annual-registration.criminal-convictions');
    }
    ...
    public function criminalConvictions(Request $request)
    {
        ...
        return view('user.application.student-annual-registration.applicant-declaration');
    }
    ...
    public function applicantDeclaration(Request $request)
    {
       ...
       return view('user.application.student-annual-registration.supporting-documents');
    }
    ...
    public function payment()
  {
    ...
    return view('user.application.student-annual-registration.payment');
  }
  ...
  public function paymentInitiate(Request $request)
  {
    ...
    session()->forget('other_acheivement');
