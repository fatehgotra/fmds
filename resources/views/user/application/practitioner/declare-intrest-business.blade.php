...
<h3>7. Declare Interest in Relevant Business</h3>
<form method="post" action="{{ route('user.practitioner.declare-intrest-business') }}">
    @csrf
...
<form id="backForm" method="post" action="{{ route('user.practitioner.profesional-indeminity') }}">
@csrf
