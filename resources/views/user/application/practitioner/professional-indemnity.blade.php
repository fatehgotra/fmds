...
<h3>5. Professional Indemnity</h3>
<form method="post" action="{{ route('user.practitioner.profesional-indeminity') }}">
    @csrf
...
<form id="backForm" method="post" action="{{ route('user.practitioner.qualification') }}">
@csrf
