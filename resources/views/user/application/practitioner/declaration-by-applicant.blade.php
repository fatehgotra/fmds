...
<h3>8. Declaration by Applicant</h3>
<form id="declareForm" method="post" action="{{ route('user.practitioner.declaration-by-applicant') }}">
    @csrf
            ...
            <div class="form-group">
                <div class="mb-4">
                    ...
                    <ul>
                        ...
                        <li>I declare that I am fit for practice in the vocation I am applying for;</li>
...
<form id="backForm" method="post" action="{{ route('user.practitioner.criminal-convictions') }}">
    @csrf
