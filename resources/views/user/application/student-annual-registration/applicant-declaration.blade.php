...
<h3>7. Declaration by Applicant</h3>
<form id="declareForm" method="post" action="{{ route('user.sar.applicant-declaration') }}">
    @csrf
            ...
            <div class="form-group">
                <div class="mb-4">
                    ...
                    <ul>
                        ...
                        <li>I undertake to provide the Council/Secretariat medical reports or any report should the council seek such documents;</li>
                        ...
                        <li>I consent to the Secretariat divulging relevant practice details as it sees fit;</li>
                        <li>I consent to the Secretariat verifying any information provided by me in the form;</li>
                        <li>I make this declaration in the knowledge that information provided are true & correct and;</li>
                        <li>I undertake to uphold the medical and dental profession in high esteem.</li>
                    </ul>
...
<form id="backForm" method="post" action="{{ route('user.sar.medical-fitness') }}">
    @csrf
