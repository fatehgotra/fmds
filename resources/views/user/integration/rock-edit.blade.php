            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="" class="form-horizontal">
                        ...
                        <div class="icon mb-3">
                            <img src="{{ asset('assets/images/company/icons/list-icon-2.png') }}" width="50" height="50">
                        </div>
                        <p class="text-dark fw-normal">Please enter your Rock RMS API credentials. If you need some help please view
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control form-lg" name="name" placeholder="Name/Identifier"
                             required>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control form-lg" placeholder="Application ID" name="app_id"
                             required>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input required type="text" name="secret" placeholder="Secret" class="form-control form-lg">
                        ...
                        <div class="form-check form-switch custom-switch mb-1">
                            ...
                            <input type="hidden" name="two_way_sync"  id="sync">
                ...
                <div class="modal-header d-flex justify-content-start align-items-start pb-0">
                    <div class="cus-header d-flex justify-content-start">
                        ...
                        <div class="m_title">
                            ...
                            <p class="text-white fw-normal font-15">Connecting to Rock RMS</p>
                        </div>
                    </div>
