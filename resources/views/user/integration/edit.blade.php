...
<div class="container-fluid integration-add">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Edit Integrations</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
                ...
                <div class="card-body">
                    {{-- <video id="my-video" class="video-js" controls preload="auto" poster="{{ asset('assets/images/company/video-bg.png') }}" data-setup='' loop>
                        ...
                        <ul class="list-unstyled mb-0 w-100 integration-tab">
                            ...
                            <li class="mb-0">
                                <a href="{{ route('user.integration.rock-edit') }}" class="btn btn-reminder bg-reminder">
        ...
        <div class="col-xl-8 col-lg-8 col-12">
            <div class="card">
                <div class="card-body">
                    <form id="integrationAddForm" method="POST" action="{{ route('user.integration.update',$integration->uuid) }}" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control form-lg" name="name" placeholder="Name/Identifier" value="{{ old('name',$integration->name) }}"
                             required>
                             @error('app_id')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control form-lg" placeholder="Application ID" name="app_id" value="{{ old('app_id',$integration->app_id) }}"
                             required>
                             @error('app_id')
                             <span id="app_id-error" class="error invalid-feedback">{{ $message }}</span>
                             @enderror
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input required type="text" name="secret" placeholder="Secret" value="{{ old('secret',$integration->secret) }}" class="form-control form-lg">
                                @error('secret')
                        ...
                        <div class="form-check form-switch custom-switch mb-1">
                            <input class="form-check-input mt-0" type="checkbox" @if($integration->two_way_sync == 1 ) checked @endif  role="switch" id="flexSwitchCheckChecked">
                            <input type="hidden" name="two_way_sync" value="{{ $integration->two_way_sync }}" id="sync">
