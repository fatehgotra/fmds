<div class="end-bar">
    ...
    <div class="rightbar-title2">
        <div class="unread">
            <button type="button" class="btn btn-primary">Unread <span class="counter">{{ unreadAdminNotifications()['count'] }}</span></button>
        </div>
    ...
    <div class="rightbar-content h-100" data-simplebar>
        ...
        <div class="notification-list">
            <!-- item-->
             @if( count( sidebarAdminNotifications() ) > 0 )
             @foreach( sidebarAdminNotifications() as $notice )

            <a href="{{ $notice->data['link'] }}" class="dropdown-item notify-item reminder">
