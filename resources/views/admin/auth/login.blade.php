...
<body class="">
    ...
    <div class="auth-fluid auth_admin">
        <!--Auth fluid left content -->
        <div class="auth-fluid-form-box pb-4 px-3 adminloginform">
            <div class="align-items-center admin_form_m d-flex h-100">
                <div class="card-body">

                    <!-- Logo -->
                    <div class="auth-brand text-center">
                        <a href="/" class="logo-dark">
                            <span><img src="{{ asset('assets/images/logo.png') }}" width="385" height="65"></span>
                        </a>
                    ...
                    <!-- title-->
                    <h4 class="mt-5">Administator Login</h4>
                    ...
                    <form method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="col-sm-6 col-6">
                                <div class="forgot">
                                    <p class="mb-0 float-end">
                                        Forgot your
                                        <a href="{{ route('admin.password.request') }}" class=""> password?</a>
                                    </p>
                        ...
                        <div class="d-grid mb-0 text-center">
                            <button class="btn btn-primary btn-userlogin" type="submit"><i class="mdi mdi-login"></i> Log In
                            </button>
                        </div>
                    </form>
                    <!-- end form-->
