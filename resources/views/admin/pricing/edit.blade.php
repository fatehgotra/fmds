...
<div class="container-fluid Pricing Pricing_edit">
    ...
    <div class="tab-content">
        <div class="tab-pane show active" id="packages">
            <form method="POST" action="{{ route('admin.packages.update', $package->id) }}" id="PageForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $package->name) }}" class="form-control @error('name') is-invalid @enderror form-lg" placeholder="Starter">
                                    @error('name')
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="billing_cycle" class="form-control @error('billing_cycle') is-invalid @enderror form-lg">
                                        ...
                                        <option value="yearly" @if(old('billing_cycle', $package->billing_cycle) == "yearly") selected @endif >Yearly</option>
                                        <option value="monthly" @if(old('billing_cycle', $package->billing_cycle) == "monthly") selected @endif >Monthly</option>
                                        <option value="weekly" @if(old('billing_cycle', $package->billing_cycle) == "weekly") selected @endif >Weekly</option>
                                        <option value="half yearly" @if(old('billing_cycle', $package->billing_cycle) == "half yearly") selected @endif >Half yearly</option>
                                        <option value="daily" @if(old('billing_cycle', $package->billing_cycle) == "daily") selected @endif >Daily</option>
                                    </select>
                                    @error('billing_cycle')
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" name="price" value="{{ old('price', $package->price) }}" class="form-control @error('price') is-invalid @enderror form-lg">
                                    </div>
                                    @error('price')
                                ...
                                <div class="mb-0">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror form-lg">
                                        ...
                                        <option value="0" {{ (old('status', $package->status) == 0) ? 'selected' : '' }}>In-active</option>
                                    </select>
                                    @error('status')
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" name="is_include_contacts" @if($package->is_include_contacts == 1) checked @endif class="form-check-input" id="customSwitch0">
                                        <label class="form-check-label" for="customSwitch0">Unlimited Contacts</label>
                                    </div>

                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_include_numbers == 1) checked @endif name="is_include_numbers" class="form-check-input" id="customSwitch1">
                                        <label class="form-check-label" for="customSwitch1">Includes number</label>
                                    </div>

                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_sms_fallback == 1) checked @endif name="is_sms_fallback" class="form-check-input" id="customSwitch2">
                                        <label class="form-check-label" for="customSwitch2">SMS Fallback</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_unlimited_lists == 1) checked @endif name="is_unlimited_lists" class="form-check-input" id="customSwitch3">
                                        <label class="form-check-label" for="customSwitch3">Unlimited Lists</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_unlimited_templates == 1) checked @endif name="is_unlimited_templates" class="form-check-input" id="customSwitch4">
                                        <label class="form-check-label" for="customSwitch4">Unlimited Templates</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_unlimited_campaigns == 1) checked @endif name="is_unlimited_campaigns" class="form-check-input" id="customSwitch5">
                                        <label class="form-check-label" for="customSwitch5">Unlimited Campaigns</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_unlimited_agents == 1) checked @endif name="is_unlimited_agents" class="form-check-input" id="customSwitch6">
                                        <label class="form-check-label" for="customSwitch6">Unlimited Agents</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" @if($package->is_unlimited_automations == 1) checked @endif name="is_unlimited_automations" class="form-check-input" id="customSwitch7">
                                        <label class="form-check-label" for="customSwitch7">Unlimited Automations</label>
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label class="control-label">Contacts</label>
                                    <input type="number" name="no_of_contacts" value="{{ old('no_of_contacts', $package->no_of_contacts) }}" placeholder="Contacts" class="form-control @error('no_of_contacts') is-invalid @enderror form-lg">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="no_of_contact_lists" placeholder="Contacts Lists" value="{{ old('no_of_contact_lists', $package->no_of_contact_lists) }}" class="form-control @error('no_of_contact_lists') is-invalid @enderror form-lg">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="no_of_message_templates" placeholder="Message Templates" value="{{ old('no_of_message_templates', $package->no_of_message_templates) }}" class="form-control @error('no_of_message_templates') is-invalid @enderror form-lg">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="no_of_campaign" placeholder="Campaigns" value="{{ old('no_of_campaign', $package->no_of_campaign) }}" class="form-control @error('no_of_campaign') is-invalid @enderror form-lg">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="no_of_team_agent" placeholder="Agents" value="{{ old('no_of_team_agent', $package->no_of_team_agent) }}" class="form-control @error('no_of_team_agent') is-invalid @enderror form-lg">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" name="no_of_automations" placeholder="Automations" value="{{ old('no_of_automations', $package->no_of_automations) }}" class="form-control @error('no_of_automations') is-invalid @enderror form-lg">
                    ...
                    <div class="col-sm-12">
                        <div class="float-end">
                            ...
                            <input type="submit" value="Update" class="btn btn-primary ms-2">
                        </div>
                    </div>
                </div>
            </form>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mb-2">
                            ...
                            <select name="" id="" class="form-control form-lg">
                                <option value="">Please select</option>
