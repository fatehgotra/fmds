...
export default function NumberNode({ data }) {
    ...
    let val = autoData?.find(d => d.name === 'NumberNode')?.value;
    ...
    return (
        <>
            ...
            <div className="wd-aside">
                <div className="card">
                    <h5 className="card-header bg-light">Number Block
                    <button
                    ...
                    <div className="card-body">
                        <input type="text"   name="NumberNode" onBlur={(e)=>onChangeNode(e)} className="form-control" placeholder="Type a number.."/>
                    </div>
                </div>
            </div>
