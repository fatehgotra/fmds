...
export default function EmailNode({ data }) {
    ...
    let val = autoData?.find(d => d.name === 'EmailNode')?.value;
    return (
        <>
            ...
            <div className="wd-aside">
                <div className="card">
                    <h5 className="card-header bg-light">Email Block
                    <button
                    ...
                    <div className="card-body">
                        <input type="text"  name="EmailNode" onBlur={(e)=>onChangeNode(e)} className="form-control" placeholder="Type an email.."/>
                    </div>
                </div>
            </div>
